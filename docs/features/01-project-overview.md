...
Пользователь создаётся командой `/start`, затем выбирает язык и город вылета из списка городов Узбекистана. В профиле также хранятся общие настройки:

- класс: `economy` или `business`;
- багаж: не важно или только с багажом;
- выбранный origin в Узбекистане;
