...
function pricesSection(dashboard: AdminDashboard): string {
  ...
  const analytics = dashboard.priceAnalytics ?? { query: { destinationCode: null, originCode: null, periodDays: 30 as const }, origins: [], series: [] };
